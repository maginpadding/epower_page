<template>
  <div class="container">
	<div class="header">
		<h1>Discuz! 安装向导</h1>
		<span>Discuz!X3.4 简体中文 UTF8 版 20180101</span></div>
...
</p><p>本服务条款一旦发生变更, 康盛将在网页上公布修改内容。修改后的服务条款一旦在网站管理后台上公布即有效代替原来的服务条款。您可随时登陆康盛官方论坛查阅最新版服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，康盛公司有权随时中止或终止您对康盛产品的使用资格并保留追究相关法律责任的权利。</p>
<p>在理解、同意、并遵守本协议的全部条款后，方可开始使用康盛产品。您可能与康盛公司直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p><p></p>
...
<p align="right">康盛公司</p>
	...
	<div class="btnbox marginbot">
		<form method="get" autocomplete="off" action="/step1">
	...
	</div>		<div class="footer">©2001 - 2017 <a href="http://www.comsenz.com/">Comsenz</a> Inc.</div>
	</div>
</div>
